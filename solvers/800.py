#!/usr/bin/env python
"""Adapted from https://github.com/igorvanloo/Project-Euler-Explained/blob/main/pe00800%20-%20Hybrid%20Integers.py"""
# -*- coding: utf-8 -*-
"""
...
if __name__ == "__main__":
    assert any(x[0] == 800 for x in bruteforce(800))
    assert C(800, 1) == 2
