#!/usr/bin/env python
'''Adapted from https://github.com/igorvanloo/Project-Euler-Explained/blob/main/pe00795%20-%20Alternating%20GCD%20sum.py'''
# -*- coding: utf-8 -*-
"""
...
def g_small(n):
    ...
    for i in range(1, n + 1):
        total += (-1)**i * math.gcd(n, i*i)
    return total

def G_small(n):
    return sum(g_small(x) for x in range(1, n + 1))

if __name__ == "__main__":
    assert g_small(4) == 6
    assert g_small(1234) == 1233
    assert G_small(1234) == 2194708
    print(G(12345678))
