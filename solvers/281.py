#!/usr/bin/env python
"""Adapted from https://github.com/igorvanloo/Project-Euler-Explained/blob/main/pe00281%20-%20Pizza%20Toppings.py"""
# -*- coding: utf-8 -*-
"""
...
def f(m, n):
    return sum(
        [
            phi(n // d) * math.factorial(m * d) // pow(math.factorial(d), m)
